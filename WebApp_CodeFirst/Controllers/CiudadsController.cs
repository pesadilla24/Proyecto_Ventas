...
namespace WebApp_CodeFirst.Controllers
{
    public class CiudadsController : Controller
    {
        private readonly MyDbContext _context;

        public CiudadsController(MyDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion")] Ciudad ciudad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion")] Ciudad ciudad)
        {
            if (id != ciudad.Id)
            {
                return NotFound();
